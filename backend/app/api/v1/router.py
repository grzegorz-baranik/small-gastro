...
from app.api.v1 import ingredients, products, categories, daily_records, inventory, sales, transactions, dashboard
...
api_router.include_router(inventory.router, prefix="/inventory", tags=["Magazyn"])
