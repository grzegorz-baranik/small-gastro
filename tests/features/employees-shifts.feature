...
Feature: Employees & Shifts Management
  ...
  Scenario: Create a new position with hourly rate
  ...
  Scenario: Edit an existing position
    Given a position "Cook" exists with hourly rate "25.00"
  ...
  Scenario: Delete position without employees
    Given a position "Helper" exists with hourly rate "20.00"
  ...
  Scenario: Create employee with position's default rate
    Given a position "Cashier" exists with hourly rate "22.00"
    When I click the "Add employee" button
    And I enter "Anna Smith" as the employee name
  ...
  Scenario: Create employee with custom hourly rate override
    Given a position "Cashier" exists with hourly rate "22.00"
    When I click the "Add employee" button
    And I enter "Peter Smith" as the employee name
    And I select "Cashier" as the position
  ...
  Scenario: Deactivate an employee
    Given an employee "John Smith" exists and is active
  ...
  Scenario: Reactivate an inactive employee
    Given an employee "John Smith" exists and is inactive
    And I toggle to show inactive employees
  ...
  Scenario: Filter employees by active status
    Given an employee "John Smith" exists and is active
    And an employee "Anna Smith" exists and is inactive
    ...
    When I toggle to show inactive employees
  ...
  Scenario: Add employee to current day's shift
    Given a daily record exists for today and is open
  ...
  @shifts @daily-operations @happy-path
  Scenario: Successfully close day with employees assigned
    Given a daily record exists for today and is open
  ...
  Scenario: Cannot modify shifts after day is closed
    Given a daily record exists for today and is closed
  ...
  Scenario: Create wage transaction for an employee
    Given an employee "John Smith" exists
    And the "Wages" expense category exists
  ...
  Scenario: Cannot create wage transaction without selecting employee
    Given the "Wages" expense category exists
    When I go to the finances page
    And I click the "Add expense" button
    And I select "Wages" as the category
    And I enter "4500.00" as the amount
